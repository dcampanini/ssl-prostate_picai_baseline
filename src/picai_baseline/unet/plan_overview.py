...
from picai_baseline.splits.uc import nnunet_splits as uc_splits
from picai_baseline.splits.prostate158 import nnunet_splits as prostate158_splits
        ...
        for split, nnunet_split in nnunet_fold.items():
            ...
            for subject_id in nnunet_split:
                try:
                    ...
                    if 'prostate158' in subject_id:
                        patient_id = subject_id
                        study_id = subject_id.split('-')[1]
                        subject_id = patient_id+'_'+study_id
                    else:
                        patient_id = 'UC-'+subject_id
                        study_id = subject_id
                        subject_id = patient_id+'_'+study_id
