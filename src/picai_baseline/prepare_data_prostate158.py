...
from picai_baseline.splits.prostate158 import \
    nnunet_splits as prostate158_splits
...
def prepare_data(
    ...
    labelsdir: str = "picai_labels/csPCa_lesion_delineations/human_expert/resampled",
    ...
    splits: str = "prostate158",
    task: str = "Task2401_p158_prostate",
):
    ...
    # select splits
    splits = {
        "prostate158": prostate158_splits
    }[splits]
    ...
    if mha2nnunet_settings_path.exists():
        ...
        print('PREPROCESSING:', mha2nnunet_settings["preprocessing"])
...
if __name__ == "__main__":
    ...
    prepare_data(task='Task2401_p158_prostate', matrix_size=[32,256,256])
    print("Finished.")
